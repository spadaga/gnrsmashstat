      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border dark:border-slate-700 p-4">
        ...
        <div className="space-y-1">
          {players.map((p) => {
            ...
            return (
              <div key={playerName} className="flex items-center justify-between px-2 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700">
                ...
                {isAdmin && (
                  <button onClick={() => setConfirm(playerName)} className="text-slate-300 hover:text-red-500"><Trash2 size={15} /></button>
                )}
              </div>
            )
          })}
